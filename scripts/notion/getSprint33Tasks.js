#!/usr/bin/env node
/**
 * Fetch Sprint 33 tasks from Notion
 */
...
async function getSprint33Tasks() {
  console.log('🔍 Fetching Sprint 33 tasks from Notion...\n');

  try {
    // Query for Sprint 33 features
    ...
    console.log(`✅ Found ${response.results.length} tasks for Sprint 33\n`);
    console.log('='.repeat(70));
    console.log('SPRINT 33 TASKS');
    console.log('='.repeat(70));
    console.log('');
    ...
    console.error('❌ Failed to fetch Sprint 33 tasks:', error.message);
    if (error.body) {
