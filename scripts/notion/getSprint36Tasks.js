#!/usr/bin/env node
/**
 * Fetch Sprint 36 tasks from Notion
 */
...
async function getSprint36Tasks() {
  console.log('🔍 Fetching Sprint 36 tasks from Notion...\n');
  ...
  try {
    ...
    console.log(`✅ Found ${response.results.length} tasks for Sprint 36\n`);
    console.log('='.repeat(70));
    console.log('SPRINT 36 TASKS');
    console.log('='.repeat(70));
    console.log('');
    ...
    console.error('❌ Failed to fetch Sprint 36 tasks:', error.message);
    if (error.body) {
