#!/usr/bin/env node
/**
 * Fetch Sprint 35 tasks from Notion
 */
...
async function getSprint35Tasks() {
  console.log('🔍 Fetching Sprint 35 tasks from Notion...\n');
  ...
  try {
    ...
    console.log(`✅ Found ${response.results.length} tasks for Sprint 35\n`);
    console.log('='.repeat(70));
    console.log('SPRINT 35 TASKS');
    console.log('='.repeat(70));
    console.log('');
    ...
    console.error('❌ Failed to fetch Sprint 35 tasks:', error.message);
    if (error.body) {
